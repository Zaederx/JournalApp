...
let win; //use win instead of window to avoid conflicts with ts block scope varible "window" & typeof to avoid another naming conflict for value 'BrowserWindow'
