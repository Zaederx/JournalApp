...
function getTopics() {
    ...
    window.CRUD.readDResponse(function (dirHTML) {
        ...
        if (topics != null)
            topics.innerHTML = dirHTML;
        else
            console.error('read.ts: var topics = null');
    });
}
/**
...
function getEntries() {
    ...
    window.CRUD.readDEResponse(function (filesHTML) {
        ...
        if (files != null)
            ...
            console.error('read.ts: var files = null');
 ...
 */
function makeClickable(entryDiv) {
    entryDiv.onclick = () => {
        if (messageDiv != null)
            messageDiv.innerHTML = "";
        else
            console.log('read.ts: var messageDiv = null');
        var filename = entryDiv.innerHTML;
...
function displayEntry(entry) {
    ...
    document.querySelector('#e-body-text').innerHTML = entry.body;
