...
btn_create_entry ? btn_create_entry.onclick = () =>  clickCreateEntryBtn(entryTemp, html.title, html.body, html.messageDiv) : console.log('btn_create_entry is null');
...
btn_add_tags ? btn_add_tags.onclick = () => addSelectedTagsToEntry(entryTemp,html.messageDiv,html.entry_tags, tagTableBody3) : console.log('add_tags btn is null')
