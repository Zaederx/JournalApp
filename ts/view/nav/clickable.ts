...
function makeTagDivClickable(tagDiv:HTMLDivElement, loader:HTMLDivElement, panel_entries:HTMLDivElement) {
...
function makeEntryDivClickable(entryDiv:HTMLDivElement, loader:HTMLDivElement) {
...
export function makeAllTagsClickable(loader:HTMLDivElement, panel_entries:HTMLDivElement) {
...
export function makeAllEntriesClickable(loader:HTMLDivElement) {
    //get all entry divs
