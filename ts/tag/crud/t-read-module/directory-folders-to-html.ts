/**
   * //IMPORTANT now refers to apend-tags module for this functionality
...
//         if(subdirectoryName.charAt(0) == '.' || subdirectoryName == 'current-entry') {/*DO NOT ADD*/}//so it doesn't add .DS_Store files etc
//         else if (counter == 0) {
